            ...
            >
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-[700px] w-full mt-auto md:my-auto pb-[40px] md:pb-0">
                    ...
                    <motion.p
                        ...
                        className="font-sora font-bold text-[18px] md:text-[40px] text-white leading-[1.1] mb-2 uppercase"
                    >
                        PARE DE VEZ COM OS
                    </motion.p>
                    ...
                    >
                        Elimine os <span className="font-semibold text-brand-lime">vícios de linguagem</span> que atrapalham sua comunicação, melhore sua dicção e nunca mais seja ignorado quando falar!
                    </motion.p>
